...
# Files
The file is the espnote.YAML.  We include the file (as two files).  We commented the lines that do not apply to the specific display approach.

 - espnote -  with the positional statements 
 - espnote -  with the dashboard statements 
